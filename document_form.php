...
<div class="col-lg-12">
	<div class="card card-outline card-primary">
    	...
    	<div 
        class="card-footer border-top border-info align-items-center" 
        style="<?php echo IS_EDIT ? 'grid-template-columns: 15% 75% 1fr; flex-direction: row; display: grid;' : 'display: flex'; ?>"
      >
        <?php if (IS_EDIT): ?>
          <button 
            class="btn btn-flat bg-gradient-primary" 
            id="add_perm"
